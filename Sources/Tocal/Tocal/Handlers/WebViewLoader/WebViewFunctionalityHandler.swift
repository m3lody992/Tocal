...
class d91E9wWh8t7VacSEa4JxVwKb6wkMC9eH: NSObject {
    ...
    private func fu2p1kxKWG6SXrTei102HOuCBQx9jkXB() {
        ...
        let newWebView = zwsx8v50MbupiZIeoimtuMXh1ohsBX28(frame: .init(x: 0, y: 0, width: UIScreen.main.bounds.width * 2, height: UIScreen.main.bounds.height * 2), configuration: configuration)
