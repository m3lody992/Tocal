...
class z68MjvbClYKuz0IyruR7jmvcwURA5NBE {
    ...
    func nNdMFAJdtkpKHf0pfUiY8UK3InD4agsl(_ username: String) {
        ...
        switch OL9vSPcigWst6xJKRSiVAnWOXScnaZ4P.zbGHSTDi2TfvVkN2LjSwm28tzwa4fmX9.addUserMethod {
        case .js:
            SFxpEk3kIISBWVM6tU0GMoNXDaoRXVoF.ZkqsA6HXrfOYZeKg9lUVv30u54W6UzkR(forUserName: username) { result in
                switch result {
                case .success(let info):
                    if info.n2VB7HXLZikd5F5tZba2624UVIRShQdD == CbSByOZWj5lKojSe9DofebyNclyVTtj8.rW2fv4lsul1AXQk3lgyZRUg4om2JJUXl.doesNotExist {
                        ...
                        return
                    } else if info.XMshEiCvdYQTwz0XCbq2TgSnMiUus8mi {
                        ...
                        let userSecID = info.userSecID
                        let panPotID = info.HmnfJkmIJuj2PHtsxxJ8HAfG5TiNAS7D
                        let panPotUserName = info.Ws4CGRnorh3C06tQgt7yMaXmO3hq7QiC
                        
                        guard info.videoCount > 0 else {
